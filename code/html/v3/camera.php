        ...
        <nav id="navBarLeft" class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background-color: black;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="camera.php"><i class="fas fa-camera-retro"></i><span>Camera</span></a></li>
                </ul>
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body text-center"><img src="assets/img/uderwater.jpg" style="width: 90%;"></div>
                            </div>
                        </div>
